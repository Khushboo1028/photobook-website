...
const AnimalsImagePage = () => {
  ...
  const animalPics = imageArray.filter((e) => e.label === "animal");
  const listItems = animalPics.map((item) => (
    <div>
  ...
  return (
    <div>
      <h1 style={{ textAlign: "center" }}>
        View all your animal pictures here!
      </h1>
...
export default AnimalsImagePage;
